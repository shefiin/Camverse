...
const userRefundPolicyRoutes = require('./routes/user/refundPolicy');
const userShippingInfoRoutes = require('./routes/user/shippingInfo');
const userContactRoutes = require('./routes/user/contact');
const userTermsRoutes = require('./routes/user/terms');
const userReturnsInfoRoutes = require('./routes/user/returnsInfo');
...
app.use('/refund-policy', userRefundPolicyRoutes);
app.use('/shipping-info', userShippingInfoRoutes);
app.use('/contact', userContactRoutes);
app.use('/terms-and-conditions', userTermsRoutes);
app.use('/returns-info', userReturnsInfoRoutes);
